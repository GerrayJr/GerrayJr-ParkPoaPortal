...
if(isset($_POST['Save'])){
	...
	$sql = "INSERT INTO parkinginfo(parkingID,briefdescription,pricehour,priceday,securityoption,surveillanceoption,hoursoption,capacity)  VALUES ('$parkingID','$description','$hourRate','$dayRate','$security','$survey','$operation','$capacity')";										
